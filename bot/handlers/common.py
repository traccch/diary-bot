...
<b>Обновления</b>
/update — посмотреть, что нового, и обновиться одной кнопкой прямо отсюда,
не подходя к компьютеру. Перед перезапуском бот прогоняет тесты и, если
новая версия их не прошла, возвращает прежнюю.
